...
{
    public partial class danh_sach_nhap_kho : System.Web.UI.Page
    {
        ...
        {
            Session["PhieuNhapID"] = (sender as ASPxGridView).GetMasterRowKeyValue();
        }
        protected void btnXoaPhieu_Init(object sender, EventArgs e)
        {
            ...
            var _phieu = DBProvider.DB.PhieuNhapKhos.FirstOrDefault(x => x.ID == Convert.ToInt32(container.KeyValue));
