...
{
    public partial class danh_sach_quyet_toan_xi_nghiep : System.Web.UI.Page
    {
        ...
        protected void btnXoaPhieu_Init(object sender, EventArgs e)
        {
            ...
            var _phieu = DBProvider.DB.QuyetToan_XiNghieps.FirstOrDefault(x => x.ID == Convert.ToInt32(container.KeyValue));
