<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="danh-sach-quyet-toan-ben.aspx.cs" Inherits="NhienLieu.nhap_lieu.danh_sach_quyet_toan_ben" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSourceDSNhapKho" runat="server" ConnectionString="<%$ ConnectionStrings:NhienLieuConnectionString %>" SelectCommand="SELECT QuyetToan_Ben.ID, Ben.TenBen, QuyetToan_Ben.ThoiGian, QuyetToan_Ben.NgayLap, QuyetToan_Ben.DaXoa FROM QuyetToan_Ben INNER JOIN Ben ON QuyetToan_Ben.BenID = Ben.ID" UpdateCommand="UPDATE PhieuNhapKho SET SoPhieu = @SoPhieu, HoaDonSo = @HoaDonSo, NguonNhap = @NguonNhap, Ngay = @Ngay, NgayLapPhieu = @NgayLapPhieu WHERE (ID = @ID)">
