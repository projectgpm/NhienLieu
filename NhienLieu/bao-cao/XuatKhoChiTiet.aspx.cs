...
namespace NhienLieu.bao_cao
{
    public partial class XuatKhoChiTiet : System.Web.UI.Page
    {
        ...
        rpBangKeXuat CreatReport()
        {
            rpBangKeXuat rp = new rpBangKeXuat();
        ...
        protected void gridChiTietXuatKho_CustomColumnDisplayText(object sender, DevExpress.Web.ASPxGridViewColumnDisplayTextEventArgs e)
        {
